...
/* ./.libs/lt-CScan.c - temporary wrapper executable for .libs/CScan
   Generated by libtool (GNU libtool) 2.4.6

   The CScan program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "CScan"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# CScan - temporary wrapper script for .libs/CScan\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The CScan program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"CScan:CScan:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"CScan:CScan:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"CScan:CScan:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
